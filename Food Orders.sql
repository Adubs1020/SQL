...
#This is sample data from an online food ordering app of restuarants in New York City.
# Performed exploratory data analysis in MYSQL to develop insights into the data.
